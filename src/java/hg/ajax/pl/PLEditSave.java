...
/* ========================================================================= */
/**
 * Save the changes made to a pricelist.
 */
/* ========================================================================= */
public class PLEditSave extends HttpServlet
    {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
            ...
            String strDBID   = request.getParameter("pl_db_id");
            ...
            // Parameters OK, update list.
            int iDBID = Integer.parseInt(strDBID);
            ...
            DBR res = Delphi.Inst().PricelistUpdate(iDBID, strPLName, isoStart, isoEnd);
            if (! res.OK()) 
                {
