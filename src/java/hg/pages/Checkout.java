...
/* ========================================================================= */
/**
 * Show all the guests of a reservation which are checked in.
 */
/* ========================================================================= */
public class Checkout extends HttpServlet
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
            ...
            Util.CommonElementsOnPages(ciPage, usr, hot, PageID.CHECKOUT);
            ciPage.AddJSLink("scripts/checkout.js");
            
            // Action buttons
            Actions actBtns = ciPage.getActions();
            actBtns.AddAction(usr.Txt(Loc.CHECKOUTCHOSEN), "javascript:doCheckout()");
            ...
            for (ResGuest g : guests) 
                ...
                if (g.IsCheckedIn()) 
                    ...
                    String oddEven = (isOdd) ? CSS.CROW_ODD : CSS.CROW_EVEN ;
                    isOdd = !isOdd;
            ...
            // Add a javascript variable to hold the identity of the invoice.
            ciPage.AddJSCode("var invoiceID = " + reservation.getInvoiceID() + ";");
            
            // An extra div for decorative purposes.
            Div extraDiv = new Div("extra_checkout", null);
